...
describe("Deliverables Operations", () => {
  ...
  it("should handle addDeliverable operation", () => {
    ...
    expect(updatedDocument.operations.global[0].action.type).toBe("ADD_DELIVERABLE");
  ...
  it("should handle removeDeliverable operation", () => {
    ...
    expect(updatedDocument.operations.global[1].action.type).toBe("REMOVE_DELIVERABLE");
  ...
  it("should handle editDeliverable operation", () => {
    ...
    expect(updatedDocument.operations.global).toHaveLength(2);
    expect(updatedDocument.operations.global[1].action.type).toBe("EDIT_DELIVERABLE");
    expect(updatedDocument.operations.global[1].action.input).toStrictEqual(input);
    expect(updatedDocument.operations.global[1].index).toEqual(1);
    expect(updatedDocument.state.global.deliverables[0].owner).toBe(input.owner);
    ...
    it("should handle setDeliverableProgress percentage operation", () => {
      ...
      expect(updatedDocument.operations.global).toHaveLength(2);
      expect(updatedDocument.operations.global[1].action.type).toBe("SET_DELIVERABLE_PROGRESS");
      expect(updatedDocument.operations.global[1].action.input).toStrictEqual(input);
      expect(updatedDocument.operations.global[1].index).toEqual(1);
    ...
    it("should handle addKeyResult operation", () => {
      ...
      expect(updatedDocument.operations.global).toHaveLength(2);
      expect(updatedDocument.operations.global[1].action.type).toBe("ADD_KEY_RESULT");
      expect(updatedDocument.operations.global[1].action.input).toStrictEqual(input);
      expect(updatedDocument.operations.global[1].index).toEqual(1);
    ...
    it("should handle removeKeyResult operation", () => {
      const input: RemoveKeyResultInput = {
        id: "1",
        deliverableId: "1",
      };
      ...
      expect(updatedDocument.operations.global[2].action.type).toBe("REMOVE_KEY_RESULT");
    ...
    it("should handle setDeliverableBudgetAnchorProject operation", () => {
      ...
      expect(updatedDocument.operations.global).toHaveLength(2);
      expect(updatedDocument.operations.global[1].action.type).toBe("SET_DELIVERABLE_BUDGET_ANCHOR_PROJECT");
      expect(updatedDocument.operations.global[1].action.input).toStrictEqual(input);
      expect(updatedDocument.operations.global[1].index).toEqual(1);
